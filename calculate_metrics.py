...
metric_specs = {
    'fid':          dnnlib.EasyDict(detector_kwargs=dnnlib.EasyDict(class_name='calculate_metrics.InceptionV3Detector')),
    'fd_dinov2':    dnnlib.EasyDict(detector_kwargs=dnnlib.EasyDict(class_name='calculate_metrics.DINOv2Detector')),
}
